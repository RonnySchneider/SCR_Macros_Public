...
_OPTIONS = {
    ...
    "checkBox_line":            True,
    "checkBox_text":            True,
    "projectsinglepoint":       True,
    "projectmultipoints":       False,
    "projectdirectionalshot":   False,
}
...
class SCR_PerpDistToFace(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_PerpDistToFace", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_PerpDistToFace", _OPTIONS)
