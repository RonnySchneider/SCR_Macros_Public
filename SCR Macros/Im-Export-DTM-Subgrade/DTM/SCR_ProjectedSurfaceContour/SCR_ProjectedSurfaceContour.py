...
class SCR_ProjectedSurfaceContour(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_ProjectedSurfaceContour", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_ProjectedSurfaceContour", _OPTIONS)
