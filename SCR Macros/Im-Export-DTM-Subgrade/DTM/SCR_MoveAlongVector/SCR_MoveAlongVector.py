...
_OPTIONS = {
    ...
    "offset":               0.0,
    "touchsurface":         False,
    "touchsurfacepicker":   0,
    "returntocoordCtl1":    False,
}
...
class SCR_MoveAlongVector(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_MoveAlongVector", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_MoveAlongVector", _OPTIONS)    
