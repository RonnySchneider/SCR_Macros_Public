...
class SCR_ElevateToPlane(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_ElevateToPlane", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_ElevateToPlane", _OPTIONS)
    ...
    def drawoverlay(self):
        ...
        l1 = self.linepicker1.Entity
        if self.linewithlimits.IsChecked and l1:
        ...
        if isinstance(o, Linestring):
            ...
            for i in range(0, o.ElementCount):
                ...
                if not "PointId" in etype.Name and not "Dependent" in etype.Name:
                    ...
                    estation = self.computechainage(polyseg, self.currentProject.Concordance.Lookup(e.LocationSerialNumber).Position)
