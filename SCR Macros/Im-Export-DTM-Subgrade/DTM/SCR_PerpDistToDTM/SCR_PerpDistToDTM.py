...
_OPTIONS = {
    ...
    "usedtm":                   True,
    "computeplumb":             False,
    "outcolorpicker":           Color.Red,
    "usesinglepoint":           False,
    "showallsolutions":         False,
    "checkBox_point":           False,
    "checkBox_line":            True,
    "checkBox_text":            True,
    "unitpicker":               "Meter",
    "addunitsuffix":            False,
    ...
    "textheight":               0.1,
    "drawleader":               False,
    "checkBox_showpointrl":     False,
    "pointrlprefix":            "GirderUS=",
    "checkBox_showcomparerl":   False,
    "comparerlprefix":          "DeckTOC=",
    "checkBox_showdh":          True,
    "checkBox_resultoffset":    False,
    "resultoffset":             0.0,
    "checkBox_showoffset":      False,
    "offsetprefix":             "dhCorr=",
    "dhprefix":                 "dh=",
}
...
class SCR_PerpDistToDTM(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def OnLoad(self, cmd, buttons, event):
        ...
        SCRExpanders.wire_pairs([
            (self.expander_checkBox_text, self.checkBox_text),
        ])
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_PerpDistToDTM", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_PerpDistToDTM", _OPTIONS)
    ...
    def OkClicked(self, thisCmd, e):
        ...
        if not self.usesinglepoint.IsChecked and not self.usedtm.IsChecked:
