...
_OPTIONS = {
    "surfacepicker":                    0,
    "sliceinterval":                    0.0001,
    "startaddingfromsurfacemin":        True,
    "startaddingfromelevation":         False,
    "singlesolution":                   True,
    "targetvolume":                     1.0,
    "multisolution":                    False,
    "volumeinterval":                   1.0,
...
class SCR_VolumeContours(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_VolumeContours", _OPTIONS)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_VolumeContours", _OPTIONS)
