...
class SCR_CSVtoTable(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        settingserial = OptionsManager.GetUint("SCR_CSVtoTable.textstylepicker", 24)
        ...
        SCROptions.LoadMacroOptions(self, "SCR_CSVtoTable", _OPTIONS, self.currentProject)
    ...
    def SaveOptions(self):
        ...
        SCROptions.SaveMacroOptions(self, "SCR_CSVtoTable", _OPTIONS)
