...
class SCR_ExportStaOffEl(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_ExportStaOffEl", _OPTIONS)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_ExportStaOffEl", _OPTIONS)
            ...
            with open(filename, 'w') as f:         
                ...
                for o in self.objs:
                    if isinstance(o, CoordPoint) or isinstance(o, CadPoint):
                        ...
                        if self.exportxyz.IsChecked:
                            outputline += ',' + self.tooutputunit(o.Position.X)
                            outputline += ',' + self.tooutputunit(o.Position.Y)
                            outputline += ',' + self.tooutputunit(o.Position.Z)
