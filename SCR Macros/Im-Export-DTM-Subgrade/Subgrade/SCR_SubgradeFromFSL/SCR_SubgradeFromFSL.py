...
_OPTIONS = {
    ...
    "interval":                 1.0,
    "subgradedepth":            0.0,
    "extendtodtmleft":          True,
    "adddtmprofileleft":        True,
    "dtmprofilelengthleft":     10.0,
    "extendtodtmright":         True,
    "adddtmprofileright":       True,
    "dtmprofilelengthright":    10.0,
    "layerpicker":              8,
}
...
class SCR_SubgradeFromFSL(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_SubgradeFromFSL", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_SubgradeFromFSL", _OPTIONS)
    ...
    def drawoverlay(self):
        ...
        if l1:
            ...
            #if not math.isnan(self.startstation.Distance) and not math.isnan(self.endstation.Distance):
