...
_OPTIONS = {
    ...
    "stationoffset":        0.0015,
    "stepskew":             False,
    "depthlowstation":      0.0,
    "depthhighstation":     0.0,
    "additionallines":      10.0,
    "interval":             0.5,
    "extendtodtm":          True,
    "adddtmprofile":        True,
...
class SCR_PavementStep(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_PavementStep", _OPTIONS, self.currentProject)
    ...
    def SaveOptions(self):
        ...
        SCROptions.SaveMacroOptions(self, "SCR_PavementStep", _OPTIONS)
