...
_OPTIONS = {
    "layerpicker": 8, "prefix": "", "suffix": "", "newcode": "",
    "datainblocks": True, "namelayerpicker": 8,
    "elevlayerpicker": 8, "attrlayerpicker": 8,
    "dataintexts": False, "useelevationfromtext": True,
}
...
class SCR_PointBlock2Point(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_PointBlock2Point", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_PointBlock2Point", _OPTIONS)
