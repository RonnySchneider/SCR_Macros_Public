...
_OPTIONS = {
    "layerpicker": 8, "usepointid": True, "boltspecial": False,
    "addtosurface": False, "surfacepicker": 0,
}
...
class SCR_AutoConnectPoints(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_AutoConnectPoints", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_AutoConnectPoints", _OPTIONS)
                ...
                if not pointlist.Count == 0:
                    ...
                    if self.boltspecial.IsChecked:  # always just connect the two closest points
                        ...
                        while pointlist.Count>1: # as long as we have more than 1 point in the list
                            ...
                            if self.addtosurface.IsChecked and l != None:
