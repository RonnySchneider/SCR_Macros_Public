...
_OPTIONS = {
    ...
    "unitpicker": "Meter", "addunitsuffix": False, "textdecimals": 3.0,
    "createtext": False, "textheight": 0.2, "textlayerpicker": 8,
}
...
class SCR_PointSurfaceSlopeToCSV(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_PointSurfaceSlopeToCSV", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_PointSurfaceSlopeToCSV", _OPTIONS)
