...
_OPTIONS = {
    "layerpicker": 8, "createnamedpoint": True,
    "manualinput": True, "addtoname": "_DERIVED", "newcode": "",
    "autoincrementslider": False,
    "autoinput": False, "p1code": "", "p2code": "", "searchradius": 0.2,
}
...
class SCR_P1_XY_P2_Z(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_P1_XY_P2_Z", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_P1_XY_P2_Z", _OPTIONS)
