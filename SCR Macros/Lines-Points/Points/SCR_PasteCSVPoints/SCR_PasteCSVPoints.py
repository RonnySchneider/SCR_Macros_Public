...
_OPTIONS = {
    "layerpicker": 8, "c1isID": True, "c1isEasting": False,
    "createnamed": True, "createsimple": False,
}
...
class SCR_PasteCSVPoints(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_PasteCSVPoints", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_PasteCSVPoints", _OPTIONS)
                    ...
                    for pointdata in data:
                        ...
                        if enoughdata:
                            ...
                            if self.createnamed.IsChecked:
                                ...
                                pnew_named.Layer = self.layerpicker.SelectedSerialNumber
