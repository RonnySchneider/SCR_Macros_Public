...
_OPTIONS = {
    "layerpicker": 8, "combinemode": True, "reversel2": False, "l2is2d": False,
    "combinescalehz": 1.0, "combinescalevz": 1.0,
    "combinechordtol": 0.0001, "combinenodespacing": 0.2,
    "drawmode": False, "drawscalehz": 1.0, "drawscalevz": 1.0,
    "drawchordtol": 0.0001, "drawnodespacing": 0.2,
    "smoothmode": False,
    "straightconvertmode": False, "straightconverttonew": True, "straightconvertexisting": False,
    "smoothconvertmode": False, "smoothconverttonew": True, "smoothconvertexisting": False,
    "smoothparabolamode": True, "smoothhor": False, "smoothver": False, "smoothhorver": True,
    "smoothchordtol": 0.0001, "smoothnodespacing": 0.2,
}
...
class SCR_MergeLineProfile(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def OnLoad(self, cmd, buttons, event):
        ...
        SCRExpanders.wire_pairs([
            (self.expander_combinemode, self.combinemode),
            (self.expander_drawmode, self.drawmode),
            (self.expander_smoothmode, self.smoothmode),
        ])
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_MergeLineProfile", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_MergeLineProfile", _OPTIONS)
    ...
    def smoothconvertthepolyseg(self, o): # handover a Linestring object
    ...
    def straightconvertthepolyseg(self, o): # handover a Linestring object
    ...
    def OkClicked(self, cmd, e):
        ...
        if not self.combinemode.IsChecked and not self.drawmode.IsChecked and not self.smoothmode.IsChecked:
