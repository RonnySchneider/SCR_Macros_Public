...
_OPTIONS = {
    "createpoints": True, "vpionly": False, "createvpis": False,
    "deletesource": False, "setlayer": False, "layerpicker": 8,
}
...
class SCR_LineInfoVPI(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_LineInfoVPI", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_LineInfoVPI", _OPTIONS)
