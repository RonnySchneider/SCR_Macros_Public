...
_OPTIONS = {
    ...
    "interval": 1.0, "includegradechanges": True,
    "drawxlines": False, "drawshapes": False, "drawpoints": False,
    "drawlonglines": False, "draw3dshell": False,
    "hortol": 0.001, "nodespacing": 10.0,
}
...
class SCR_SweepShape(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_SweepShape", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_SweepShape", _OPTIONS)
    ...
    def drawoverlay(self):
        ...
        if l3:
            self.overlayBag.AddPolyline(SCROverlayBag.getpolypoints(l3), Color.Blue.ToArgb(), 4)
