...
_OPTIONS = {
    "selectlayer": False, "layerpicker": 8,
    "manualname": False, "nameinput": "",
    "createarcp": True, "createpis": True,
    "drawarclines": True, "drawpilines": True,
}
...
class SCR_LineInfoArcs(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_LineInfoArcs", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_LineInfoArcs", _OPTIONS)
