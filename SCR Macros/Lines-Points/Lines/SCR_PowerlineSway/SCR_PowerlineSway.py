...
_OPTIONS = {
    "hortol": 0.0001, "vertol": 0.0001, "nodespacing": 10000.0, "rotation": 1.5707963267948966,
}
...
class SCR_PowerlineSway(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_PowerlineSway", _OPTIONS)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_PowerlineSway", _OPTIONS)
