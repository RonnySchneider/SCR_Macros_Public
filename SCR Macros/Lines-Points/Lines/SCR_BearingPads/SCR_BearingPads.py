...
_OPTIONS = {
    "layerpicker": 8, "elevatetoshelf": False,
    "bearinglength": 0.0, "bearingwidth": 0.0,
    "twopads": True, "bearingoffset": 0.0,
    "drawoffsetline": False, "layerpicker2": 8, "lineoffset": 0.0,
    "drawdynaframe": False, "dynaframeonly": False,
    "layerpicker3": 8, "dynawidth": 0.4, "dynaheight": 0.252, "dynascale": 20.0,
}
...
class SCR_BearingPads(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def OnLoad(self, cmd, buttons, event):
        ...
        SCRExpanders.wire_pairs([
            (self.expander_elevatetoshelf, self.elevatetoshelf),
        ])
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_BearingPads", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_BearingPads", _OPTIONS)
