...
_OPTIONS = {
    "squarez": True, "independentz": False, "rotateaxes": True,
...
class SCR_RotateIFC(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_RotateIFC", _OPTIONS)
    ...
    def SaveOptions(self):
        ...
        SCROptions.SaveMacroOptions(self, "SCR_RotateIFC", _OPTIONS)
