...
_OPTIONS = {
    ...
    "dynay":             35.0,
    "dynascale":         20.0,
    "sheetnameprefix":   "Frame ",
    "sheetnameincstart": 1.0,
    "sheetnameinc":      1.0,
    "easymassframe":     True,
    "useexistingsheet":  False,
    "manualpick":        False,
}
...
class SCR_QuickDynaToSheet(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        ...
        try:
            ...
            pass
        SCROptions.LoadProjectOptions(self, "SCR_QuickDynaToSheet", _OPTIONS, self.currentProject)
    ...
    def SaveOptions(self):
        ...
        SCROptions.SaveProjectOptions(self, "SCR_QuickDynaToSheet", _OPTIONS, self.currentProject)
