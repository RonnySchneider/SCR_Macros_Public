...
class SCR_CopyXSectionsToPlanview(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_CopyXSectionsToPlanview", _OPTIONS, self.currentProject)
    ...
    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_CopyXSectionsToPlanview", _OPTIONS)
