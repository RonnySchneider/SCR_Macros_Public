...
class SCR_AlignTextToLine(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_AlignTextToLine", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_AlignTextToLine", _OPTIONS)
