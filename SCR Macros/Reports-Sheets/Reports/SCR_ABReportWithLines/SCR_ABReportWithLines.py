...
class SCR_ABReportWithLines(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadProjectOptions(self, "SCR_ABReportWithLines", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveProjectOptions(self, "SCR_ABReportWithLines", _OPTIONS, self.currentProject)
    ...
    def OkClicked(self, cmd, e):
        ...
        if not self.multipoint.IsChecked and not self.singlepoint.IsChecked:
