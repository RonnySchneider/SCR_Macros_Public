...
_OPTIONS = {
    "layerpicker":          8,
    "incolorpicker":        Color.Red,
    "outcolorpicker":       Color.Red,
    "textheight":           0.01,
    "unitpicker":           "Meter",
    "addunitsuffix":        False,
    "textdecimals":         4.0,
    "compareunitpicker":    "Meter",
    "compareaddunitsuffix": False,
    "flatnessdecimals":     0.0,
    "compareflatness1":     0.001,
    "compareflatness2":     0.300,
}
...
class SCR_BearingFlatnessCheck(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_BearingFlatnessCheck", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_BearingFlatnessCheck", _OPTIONS)
