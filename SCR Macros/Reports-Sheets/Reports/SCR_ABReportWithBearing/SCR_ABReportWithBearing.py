...
class SCR_ABReportWithBearing(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadProjectOptions(self, "SCR_ABReportWithBearing", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveProjectOptions(self, "SCR_ABReportWithBearing", _OPTIONS, self.currentProject)
