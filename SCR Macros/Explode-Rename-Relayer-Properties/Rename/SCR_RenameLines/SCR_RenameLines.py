...
_OPTIONS = {
    ...
    "linenameelev": True,
    "linenamelayername": False,
    "linenamemanual": False,
    "newlinename": "",
}
...
def Setup(cmdData, macroFileFolder):
    ...
    try:
        ...
        cmdData.Version = 1.06  # included metre to project conversion
...
class SCR_RenameLines(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_RenameLines", _OPTIONS)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_RenameLines", _OPTIONS)
