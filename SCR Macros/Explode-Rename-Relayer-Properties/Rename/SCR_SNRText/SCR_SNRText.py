...
class SCR_SNRText(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadProjectOptions(self, "SCR_SNRText", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveProjectOptions(self, "SCR_SNRText", _OPTIONS, self.currentProject)
