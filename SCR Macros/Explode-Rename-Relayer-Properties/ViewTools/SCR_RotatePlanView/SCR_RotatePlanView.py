...
class SCR_RotatePlanView(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadProjectOptions(self, "SCR_RotatePlanView", _OPTIONS, self.currentProject)

    def SaveOptions(self):
        SCROptions.SaveProjectOptions(self, "SCR_RotatePlanView", _OPTIONS, self.currentProject)
