...
_OPTIONS = {
    ...
    "openfilename": "Z:\\2709 - Day Jobs",
    "fixspecificmedia": False,
    "copy": False,
    "makerelativatnewlocation": False,
    "targetfolder": "Z:\\",
}
...
class SCR_FixMediaLinks(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        SCROptions.LoadMacroOptions(self, "SCR_FixMediaLinks", _OPTIONS)

    def SaveOptions(self):
        SCROptions.SaveMacroOptions(self, "SCR_FixMediaLinks", _OPTIONS)
