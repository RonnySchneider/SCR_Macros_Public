...
_OPTIONS = {
    "change12d": True,
    "changefc": False,
    "changefcand12d": False,
    "fcnameline": "Average Depth (m)",
    "fcnamepoint": "Depth (m)",
    "inversedepth": False,
}
...
class SCR_DepthToFC(StackPanel): # this inherits from the WPF StackPanel control
    ...
    def SetDefaultOptions(self):
        ...
        SCROptions.LoadMacroOptions(self, "SCR_DepthToFC", _OPTIONS)

    def SaveOptions(self):
        OptionsManager.SetValue("SCR_DepthToFC.surfacepicker", self.surfacepicker.SelectedIndex)
        SCROptions.SaveMacroOptions(self, "SCR_DepthToFC", _OPTIONS)
    ...
    def drawoverlay(self):
        ...
        for sn in self.lineswithno12d:
            ...
            if isinstance(o, self.lType):
                self.overlayBag.AddPolyline(SCROverlayBag.getpolypoints(o), Color.Magenta.ToArgb(), 4)
        ...
        for sn in self.lineswithnofc:
            o = self.currentProject.Concordance[sn]
            if isinstance(o, self.lType):
                self.overlayBag.AddPolyline(SCROverlayBag.getpolypoints(o), Color.Green.ToArgb(), 4)
            elif isinstance(o, self.coordpointType) or isinstance(o, self.cadpointType):
            ...
            with TransactMethodCall(self.currentProject.TransactionCollector) as failGuard:
                ...
                for o in self.objs:
                    ...
                    if isinstance(o, self.lType):
                        ...
                        if self.inversedepth.IsChecked:
                            depthaveragefloat = -depthaveragefloat
                    ...
                    if self.changefcand12d.IsChecked or self.change12d.IsChecked:
                        attrfound = False
                        try:
                    ...
                    if self.changefcand12d.IsChecked or self.changefc.IsChecked:
